            ...
            <ul class="" style="list-style-type:none;">
                <li class="nav-item h-100">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="{{ route('administrator.all_report_pdf', ['from_date' => $start, 'to_date' => $end]) }}">PDF</a>
                        <a class="dropdown-item" href="{{ route('administrator.all_report_excel', ['from_date' => $start, 'to_date' => $end]) }}">Excel</a>
                    </div>
                </li>
            </ul>
        </div>
